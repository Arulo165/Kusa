...
class SpriteImage_Thundercloud(SLib.SpriteImage_Static):  # 775
    def __init__(self, parent):
        super().__init__(
            parent,
            3.75,
...
class SpriteImage_Tiki(SLib.SpriteImage_Static):  # 776
    def __init__(self, parent):
        super().__init__(
            parent,
            3.75,
    ...
    def loadImages():
        SLib.loadIfNotInImageCache('Tiki', 'Tiki.png')


class SpriteImage_Bonia(SLib.SpriteImage_Static):  # 776
    def __init__(self, parent):
        super().__init__(
            parent,
            3.75,
            ImageCache['Knochenbums'],
            (-16, -16),
        )

    def loadImages():
        SLib.loadIfNotInImageCache('Knochenbums', 'Knochenbums.png')


class SpriteImage_Chase(SLib.SpriteImage_Static):  # 776
    def __init__(self, parent):
        super().__init__(
            parent,
            3.75,
...
ImageClasses = {
    ...
    776: SpriteImage_Tiki,
    777: SpriteImage_Bonia,
    779: SpriteImage_Chase,
}
